...
mapping.iterative_mapping(
    ...
    fastq_path='/Volumes/Luyang1/hic/tmp/senecence_Criscione2016/HiC-Sen-rep2_1.fastq',
    out_sam_path='/Volumes/Luyang1/hic/tmp/senecence_Criscione2016/HiC-Sen-rep2_1.bam',
    min_seq_len=25,
    len_step=5,
    seq_start=0,
    seq_end=100,
